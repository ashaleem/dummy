	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/ads/_server.ts.js'))
			},
			{
				id: "/api/articles",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/articles/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/articles/_slug_/_server.ts.js'))
			},
			{
				id: "/api/authors",
				pattern: /^\/api\/authors\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/authors/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/publication-details/_server.ts.js'))
			},
			{
				id: "/[slug]",
				pattern: /^\/([^/]+?)\/?$/,
